...
//     Optional<TSNode> parentFieldNode = file.findParentNodeByType(contextNode,
// "field_declaration");
...
//       String typeFromLocalVars = this.resolveTypeFromLocalVariables(file, searchScope,
// objectName);
...
//           List<TSNode> typeNodes = file.query("(type_identifier)
// @type").within(localVar).execute();
//           if (!typeNodes.isEmpty()) {
//             return file.getTextFromNode(typeNodes.get(0));
//           }
//         }
...
//       Optional<TSNode> fieldNameNode = this.fieldDeclarationService.getFieldNameNode(field,
// file);
