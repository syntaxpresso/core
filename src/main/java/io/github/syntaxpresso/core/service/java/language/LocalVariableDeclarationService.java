...
//
//   /**
//    * Finds all local variable declarations within a method. Results are unique and ordered by
// node's
//    * start byte.
//    *
...
//       return Optional.empty();
//     }
//     TSNode variableDeclaratorNode =
// localVariableDeclarationNode.getChildByFieldName("declarator");
