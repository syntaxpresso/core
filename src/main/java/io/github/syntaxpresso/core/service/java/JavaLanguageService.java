...
//    * @return The identifier type, or null if not found.
//    */
//   public JavaIdentifierType getIdentifierType(TSFile file, int line, int column, SupportedIDE
// ide) {
...
// across
//    * the project. It updates the class declaration itself, renames the file if necessary, and
// then
