...
//     List<TSNode> classes = this.classDeclarationService.getAllClassDeclaration(file);
...
//     Optional<TSNode> classNode = this.classDeclarationService.findClassByName(file,
// oldClassName);
