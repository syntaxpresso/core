...
//       return;
//     }
//     String extendsClause = String.format(" extends JpaRepository<%s, %s>", entityClassName,
// idType);
//     repositoryFile.insertTextAfterNode(nameNode, extendsClause);
//   }
//
//   /**
//    * Recursively finds a field annotated with {@code @Id} within the class hierarchy, starting
// from
//    * the given class declaration. The search proceeds up the inheritance chain until an {@code
// @Id}
//    * field is found or the top of the hierarchy is reached.
//    *
//    * @param projectRoot The root path of the project, used to locate source files for
// superclasses.
...
//    * @return An {@link Optional} containing a {@link FieldWithFile} record for the {@code @Id}
// field
...
//
//   /**
//    * Finds a field annotated with {@code @Id} directly within the given class declaration node.
// This
...
//    * @return An {@link Optional} containing the {@link TSNode} of the field if found, otherwise
// an
//    *     empty Optional.
//    */
...
//    * @return An {@link Optional} containing the {@link FieldWithFile} if an {@code @Id} is found
// in
