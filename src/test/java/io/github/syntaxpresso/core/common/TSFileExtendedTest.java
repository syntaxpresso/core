...
//       Optional<TSNode> parentMethod = testFile.findParentNodeByType(localVar,
// "method_declaration");
...
//       Optional<TSNode> parentIf = complexFile.findParentNodeByType(stringLiteral,
// "if_statement");
//       assertTrue(parentIf.isPresent(), "Should find parent if statement");
//       // Find parent for loop
//       Optional<TSNode> parentFor = complexFile.findParentNodeByType(stringLiteral,
// "for_statement");
...
//       assertTrue(parentDeclarator.isPresent(), "Should find immediate parent
// variable_declarator");
//     }
//
//     @Test
...
//         Optional<TSNode> methodDecl = testFile.findParentNodeByType(localVar,
// "method_declaration");
...
//         Optional<TSNode> classDecl = testFile.findParentNodeByType(localVar,
// "class_declaration");
