...
class MethodDeclarationServiceTest {
  ...
  class GetAllMethodDeclarationNodesTests {
    ...
    void shouldReturnEmptyListForNullTSFile() {
      ...
      List<TSNode> methodNodes =
          methodDeclarationService.getAllMethodDeclarationNodes(null, classNodes.get(0));
    ...
    void shouldReturnEmptyListForNonClassDeclarationNode() {
      ...
      List<TSNode> result =
          methodDeclarationService.getAllMethodDeclarationNodes(tsFile, methodNodes.get(0));
  ...
  class GetMethodDeclarationNodeInfoTests {
    ...
    void shouldReturnMethodDeclarationInfoWithAllCaptures() {
      ...
      List<Map<String, TSNode>> methodInfo =
          methodDeclarationService.getMethodDeclarationNodeInfo(tsFile, methodNodes.get(0));
    ...
    void shouldReturnEmptyListForNullTSFile() {
      ...
      List<Map<String, TSNode>> methodInfo =
          methodDeclarationService.getMethodDeclarationNodeInfo(null, methodNodes.get(0));
    ...
    void shouldReturnEmptyListForNonMethodDeclarationNode() {
      ...
      List<Map<String, TSNode>> methodInfo =
          methodDeclarationService.getMethodDeclarationNodeInfo(tsFile, classNodes.get(0));
  ...
  class GetMethodInvocationNodeInfoTests {
    ...
    void shouldReturnMethodInvocationInfoWithAllCaptures() {
      ...
      List<Map<String, TSNode>> invocationInfo =
          methodDeclarationService.getMethodInvocationNodeInfo(tsFile, invocationNodes.get(0));
    ...
    void shouldReturnEmptyListForNullTSFile() {
      ...
      List<Map<String, TSNode>> invocationInfo =
          methodDeclarationService.getMethodInvocationNodeInfo(null, invocationNodes.get(0));
    ...
    void shouldReturnEmptyListForNullNode() {
      ...
      List<Map<String, TSNode>> invocationInfo =
          methodDeclarationService.getMethodInvocationNodeInfo(tsFile, null);
    ...
    void shouldReturnEmptyListForNonMethodInvocationNode() {
      ...
      List<Map<String, TSNode>> invocationInfo =
          methodDeclarationService.getMethodInvocationNodeInfo(tsFile, classNodes.get(0));
  ...
  class GetMethodDeclarationTypeNodeTests {
    ...
    void shouldReturnMethodReturnTypeNode() {
      ...
      Optional<TSNode> typeNode =
          methodDeclarationService.getMethodDeclarationTypeNode(tsFile, methodNodes.get(0));
    ...
    void shouldReturnEmptyForNullParameters() {
      ...
      Optional<TSNode> result1 =
          methodDeclarationService.getMethodDeclarationTypeNode(null, validMethodNode);
      Optional<TSNode> result2 =
          methodDeclarationService.getMethodDeclarationTypeNode(tsFile, null);
  ...
  class GetMethodDeclarationNameNodeTests {
    ...
    void shouldReturnMethodNameNode() {
      ...
      Optional<TSNode> nameNode =
          methodDeclarationService.getMethodDeclarationNameNode(tsFile, methodNodes.get(0));
    ...
    void shouldReturnEmptyForNullParameters() {
      ...
      Optional<TSNode> result1 =
          methodDeclarationService.getMethodDeclarationNameNode(null, validMethodNode);
      Optional<TSNode> result2 =
          methodDeclarationService.getMethodDeclarationNameNode(tsFile, null);
  ...
  class GetMethodInvocationObjectNodeTests {
    ...
    void shouldReturnMethodInvocationObjectNode() {
      ...
      Optional<TSNode> objectNode =
          methodDeclarationService.getMethodInvocationObjectNode(tsFile, invocationNodes.get(0));
    ...
    void shouldReturnEmptyForNullParameters() {
      ...
      Optional<TSNode> result1 =
          methodDeclarationService.getMethodInvocationObjectNode(null, validInvocationNode);
      Optional<TSNode> result2 =
          methodDeclarationService.getMethodInvocationObjectNode(tsFile, null);
  ...
  class IntegrationTests {
    ...
    void methodDeclarationParsingWorksEndToEnd() {
      ...
      List<Map<String, TSNode>> methodInfo =
          methodDeclarationService.getMethodDeclarationNodeInfo(tsFile, methods.get(0));
      assertFalse(methodInfo.isEmpty());

      // Get specific parts of the method declaration
      Optional<TSNode> nameNode =
          methodDeclarationService.getMethodDeclarationNameNode(tsFile, methods.get(0));
      Optional<TSNode> typeNode =
          methodDeclarationService.getMethodDeclarationTypeNode(tsFile, methods.get(0));
