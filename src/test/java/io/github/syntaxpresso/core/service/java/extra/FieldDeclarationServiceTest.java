...
class FieldDeclarationServiceTest {
  ...
  class FindAllFieldDeclarationsTests {
    ...
    void shouldFindAllFieldsOfSpecificType() {
      List<TSNode> calculatorFields = fieldDeclarationService.findAllFieldDeclarations(testFile, "Calculator");
      assertTrue(calculatorFields.size() >= 1, "Should find at least 1 Calculator field");
      
      List<TSNode> stringFields = fieldDeclarationService.findAllFieldDeclarations(testFile, "String");
      // String might not be found as type_identifier in some tree-sitter versions
      
      List<TSNode> intFields = fieldDeclarationService.findAllFieldDeclarations(testFile, "int");
    ...
    void shouldReturnEmptyListForNonExistentType() {
      List<TSNode> nonExistentFields = fieldDeclarationService.findAllFieldDeclarations(testFile, "NonExistent");
    ...
    void shouldHandleNullParametersGracefully() {
      List<TSNode> nullFileResult = fieldDeclarationService.findAllFieldDeclarations(null, "String");
      assertTrue(nullFileResult.isEmpty(), "Should return empty list for null file");
      
      List<TSNode> nullTypeResult = fieldDeclarationService.findAllFieldDeclarations(testFile, null);
  ...
  class GetFieldTypeNodeTests {
    ...
    void shouldFindTypeNodeInFieldDeclaration() {
      ...
      Optional<TSNode> typeNode = fieldDeclarationService.getFieldTypeNode(firstCalculatorField, testFile, "Calculator");
    ...
    void shouldReturnEmptyForNonMatchingType() {
      ...
      Optional<TSNode> typeNode = fieldDeclarationService.getFieldTypeNode(stringField, testFile, "Calculator");
    ...
    void shouldHandleInvalidFieldDeclarationNode() {
      ...
      Optional<TSNode> typeNode = fieldDeclarationService.getFieldTypeNode(classNodes.get(0), testFile, "String");
  ...
  class GetFieldNameNodeTests {
    ...
    void shouldHandleInvalidDeclarationNode() {
      List<TSNode> classNodes = testFile.query("(class_declaration) @class");
      Optional<TSNode> nameNode = fieldDeclarationService.getFieldNameNode(classNodes.get(0), testFile);
    ...
    void shouldHandleNullParameters() {
      ...
      if (!fields.isEmpty()) {
        ...
        assertThrows(NullPointerException.class, () -> fieldDeclarationService.getFieldNameNode(field, null));
      }
    }
  }
  ...
  class GetFieldInstanceNodeTests {
    ...
    void shouldFindInstanceNodeInFieldWithObjectCreation() {
      ...
      Optional<TSNode> instanceNode = fieldDeclarationService.getFieldInstanceNode(fieldWithInstance, testFile, "Calculator");
    ...
    void shouldReturnEmptyForFieldWithoutObjectCreation() {
      ...
      TSNode stringField = stringFields.get(0);
      Optional<TSNode> instanceNode = fieldDeclarationService.getFieldInstanceNode(stringField, testFile, "String");
      
      assertFalse(instanceNode.isPresent(), "Should not find instance node in field without object creation");
    }
    ...
    void shouldHandleInvalidDeclarationNode() {
      List<TSNode> classNodes = testFile.query("(class_declaration) @class");
      Optional<TSNode> instanceNode = fieldDeclarationService.getFieldInstanceNode(classNodes.get(0), testFile, "Calculator");
  ...
  class FindFieldUsagesTests {
    ...
    void shouldReturnEmptyListForNonExistentField() {
      List<TSNode> nonExistentUsages = fieldDeclarationService.findFieldUsages(testFile, "nonExistent");
    ...
    @DisplayName("Should handle null parameters")
    void shouldHandleNullParameters() {
      assertThrows(NullPointerException.class, () -> fieldDeclarationService.findFieldUsages(null, "name"), "Should throw exception for null file");
      assertThrows(NullPointerException.class, () -> fieldDeclarationService.findFieldUsages(testFile, null), "Should throw exception for null field name");
    }
  }
  ...
  class FilterFieldsByTypeTests {
    ...
    void shouldFilterFieldsByTypeCorrectly() {
      ...
      List<TSNode> calculatorFields = fieldDeclarationService.filterFieldsByType(testFile, allFields, "Calculator");
      assertTrue(calculatorFields.size() >= 1, "Should filter to at least 1 Calculator field");
      
      List<TSNode> stringFields = fieldDeclarationService.filterFieldsByType(testFile, allFields, "String");
    ...
    void shouldReturnEmptyListForNonMatchingType() {
      List<TSNode> allFields = testFile.query("(field_declaration) @field");
      List<TSNode> nonExistentFields = fieldDeclarationService.filterFieldsByType(testFile, allFields, "NonExistent");
    ...
    void shouldHandleNullParametersGracefully() {
      ...
      List<TSNode> nullFileResult = fieldDeclarationService.filterFieldsByType(null, allFields, "String");
      assertTrue(nullFileResult.isEmpty(), "Should handle null file gracefully");
      
      List<TSNode> nullFieldsResult = fieldDeclarationService.filterFieldsByType(testFile, null, "String");
      assertTrue(nullFieldsResult.isEmpty(), "Should handle null fields list gracefully");
      
      List<TSNode> nullTypeResult = fieldDeclarationService.filterFieldsByType(testFile, allFields, null);
  ...
  class IntegrationTests {
    ...
    void shouldWorkTogetherToAnalyzeFieldInformation() {
      ...
      // Check each field
      for (TSNode field : calculatorFields) {
        Optional<TSNode> typeNode = fieldDeclarationService.getFieldTypeNode(field, testFile, "Calculator");
        Optional<TSNode> nameNode = fieldDeclarationService.getFieldNameNode(field, testFile);
        ...
        String fieldName = testFile.getTextFromNode(nameNode.get());
        assertTrue(List.of("calculator", "backup").contains(fieldName), 
    ...
    void shouldHandleComplexFieldScenarios() {
      ...
      List<TSNode> calculatorFields = fieldDeclarationService.findAllFieldDeclarations(complexFile, "Calculator");
      ...
      boolean foundFieldWithInstance = false;
      for (TSNode field : allFields) {
        String fieldText = complexFile.getTextFromNode(field);
        if (fieldText.contains("new Calculator")) {
          Optional<TSNode> instanceNode = fieldDeclarationService.getFieldInstanceNode(field, complexFile, "Calculator");
          if (instanceNode.isPresent()) {
            foundFieldWithInstance = true;
            break;
          }
        }
      }
