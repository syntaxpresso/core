...
//
//       // Test null file
//       assertFalse(methodDeclarationService.renameMethodDeclaration(null, firstMethod,
// "newName"));
//
...
//       if (!classes.isEmpty()) {
//         TSNode nonMethodNode = classes.get(0).getChild(0); // Get first child which is not a
// method
//         boolean result =
...
//
//       List<TSNode> usages =
//           methodDeclarationService.findMethodUsagesInFile(targetFile, "calculateSum",
// "Calculator");
//
