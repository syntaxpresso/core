  ...
  class GetMainClassTests {
    ...
    void shouldFindMainClassWhenFileNameMatches() throws IOException {
      ...
      Optional<String> className =
          classDeclarationService.getClassName(fileWithCorrectName, mainClass.get());
    ...
    void shouldExtractFieldNameFromFieldDeclaration() {
      ...
      for (TSNode fieldDecl : fieldDeclarations) {
        Optional<TSNode> fieldNameNode =
            classDeclarationService.getFieldNameNode(testFile, fieldDecl);
        ...
        assertTrue(
            List.of("name", "count", "helper").contains(fieldName),
    ...
    void shouldExtractFieldTypeFromFieldDeclaration() {
      ...
      for (TSNode fieldDecl : fieldDeclarations) {
        Optional<TSNode> fieldTypeNode =
            classDeclarationService.getFieldTypeNode(testFile, fieldDecl);
