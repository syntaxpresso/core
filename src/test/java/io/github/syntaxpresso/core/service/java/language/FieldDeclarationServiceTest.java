...
//         assertFalse(fieldDeclarationService.getFieldTypeNode(null, testFile,
// "String").isPresent());
...
//       assertFalse(stringFields.isEmpty(), "Should have String fields to test");
//       TSNode stringField = stringFields.get(0);
//       Optional<TSNode> nameNode = fieldDeclarationService.getFieldNameNode(stringField,
// testFile);
...
//           fieldDeclarationService.getFieldInstanceNode(fieldWithInstance, testFile,
// "Calculator");
...
//       List<TSNode> classNodes = testFile.query("(class_declaration) @class").execute();
//       Optional<TSNode> instanceNode =
//           fieldDeclarationService.getFieldInstanceNode(classNodes.get(0), testFile,
// "Calculator");
//       assertFalse(instanceNode.isPresent(), "Should return empty for non-field-declaration
// node");
//     }
//   }
//
...
//       assertTrue(
//           actualCode.contains("private Person person;"), "Should rename first field
// declaration");
//       assertTrue(
//           actualCode.contains("private Person admin;"), "Should rename second field
// declaration");
//       assertTrue(
...
//       assertTrue(
//           actualCode.contains("this.person.setName(\"test\");"), "Should rename this.field
// access");
//       assertTrue(
//           actualCode.contains("this.admin.activate();"), "Should keep admin field access as is");
//       assertTrue(
//           actualCode.contains("User temp = this.person;"), "Should keep local variable type as
// is");
//       assertTrue(actualCode.contains("temp = person;"), "Should rename field in simple
// assignment");
...
//       assertTrue(
//           actualCode.contains("private Supervisor supervisor;"), "Should rename field
// declaration");
...
//       assertTrue(actualCode.contains("this.supervisor.process();"), "Should rename field
// access");
//       // Parameter usage should NOT be renamed
//       assertTrue(actualCode.contains("param.process();"), "Should preserve parameter usage");
//       assertTrue(actualCode.contains("Manager local = param;"), "Should preserve local
// variable");
//       assertTrue(actualCode.contains("this.supervisor = local;"), "Should rename field
// assignment");
//     }
//
//     @Test
...
//       assertTrue(
//           actualCode.contains("private DataSource dataSource;"), "Should rename field
// declaration");
...
//       assertTrue(actualCode.contains("this.job = newTask;"), "Should rename field in
// assignment");
...
//       assertTrue(
//           actualCode.contains("String service2 = \"test\";"), "Should not rename local
// variable");
//     }
//
//     @Test
