...
//       assertEquals(1, stringParams.size(), "Should find 1 String parameter in
// processCalculator");
//     }
//
//     @Test
...
//       assertEquals(2, calculatorParams.size(), "Should find 2 Calculator parameters in
// testMethod");
//     }
//
//     @Test
...
//       List<TSNode> params =
//           formalParameterService.findAllFormalParameters(testFile, classNodes.get(0),
// "Calculator");
...
//       assertFalse(formalParameterService.getParameterTypeNode(param, testFile,
// null).isPresent());
//     }
//
//     private TSNode findMethodByName(String methodName) {
...
// formalParameterService.isFormalParameterDeclaration(nameNode.get());
...
//       assertFalse(isDeclaration, "Should not identify method invocation as parameter
// declaration");
//     }
//
//     @Test
...
//       TSNode testMethod = findMethodByName("testMethod");
//       List<TSNode> usages =
//           formalParameterService.findAllFormalParameterUsages(testFile, testMethod,
// "Calculator");
...
//       assertTrue(
//           usages.isEmpty(), "Should return empty list when no parameters of specified type
// exist");
//     }
//
//     @Test
...
//       String complexCode =
//           """
//           public void complexMethod(Calculator calc, List<Calculator> calcs, Calculator...
// varArgs) {
//             calc.process();
...
//       List<TSNode> calculatorParams =
//           formalParameterService.findAllFormalParameters(complexFile, complexMethod,
// "Calculator");
...
//       for (TSNode param : calculatorParams) {
//         Optional<TSNode> nameNode = formalParameterService.getParameterNameNode(param,
// complexFile);
