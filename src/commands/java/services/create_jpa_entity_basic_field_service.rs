...
use crate::commands::java::treesitter::types::basic_field_config::BasicFieldConfig;
...
pub fn run(
  ...
  // Step 6: Save file with working directory validation
  entity_ts_file
    .save_to_existing_file(entity_file_path, cwd)
