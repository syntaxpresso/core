...
mod package_declaration_tests {
  ...
  mod get_package_declaration_node_tests {
    ...
    fn test_valid_multi_component_package() {
      ...
      assert!(
        text.contains("package com.example.myapp"),
        "Should contain full package declaration"
      );
    }
    ...
    fn test_deep_nested_package() {
      ...
      let text = ts_file.get_text_from_node(&node).expect("Should get text from node");
      assert!(
        text.contains("com.company.project.module.submodule.feature"),
        "Should contain full deep package name"
      );
    }
  ...
  mod get_package_class_scope_node_tests {
    ...
    fn test_deep_nested_package_scope() {
      ...
      let text = ts_file.get_text_from_node(&node).expect("Should get text from node");
      assert_eq!(
        text, "com.company.project.module.submodule",
        "Should return all but rightmost component"
      );
    }
  ...
  mod get_package_scope_node_tests {
    ...
    fn test_complete_deep_nested_identifier() {
      ...
      let text = ts_file.get_text_from_node(&node).expect("Should get text from node");
      assert_eq!(
        text, "com.company.project.module.submodule.feature",
        "Should return complete deep package identifier"
      );
    }
  ...
  mod integration_tests {
    ...
    fn test_comprehensive_package_parsing() {
      ...
      let class_name_text =
        ts_file.get_text_from_node(&class_name.unwrap()).expect("Should get class name text");
      ...
      let complete_text =
        ts_file.get_text_from_node(&complete.unwrap()).expect("Should get complete text");
